...
- [ ] AI動画（Google Flow）は**1本あたり最大20本**。基準は「動きが物語の核心」「静止画で不可能」「感情ピーク」の3つ
