...
キャラプロンプト（1:1）:
```
(CHAR-01 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-01: Japanese farmer, 61 years old, short cropped grey hair, CLEAN-SHAVEN with no beard, no moustache and no stubble, lying motionless on the ground, clearly dead and NOT sleeping. His face is drained to a pale bluish-white with grey shadows under the eyes, eyes closed, mouth slack and slightly open, head fallen limply to one side, one arm flung out at an unnatural angle and the other twisted beneath him, legs splayed apart. His faded dark green work jacket and brown work trousers are badly torn and ragged, with long rips, a torn-off sleeve cuff and frayed shreds hanging loose, and one black rubber boot is missing. A few thin dark scratch lines are drawn on his forearms and shins in simple cartoon style. His expression is NOT peaceful, NOT smiling and NOT relaxed. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body, seen from slightly above. White background. 1:1 aspect ratio. No blood, no gore, no open wounds. Generate 1 image.
```
→ 背景再使用: 020（夜の沢底）
...
キャラプロンプト（1:1）:
```
(CHAR-01 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, slightly chibi proportions, children's animation style. CHAR-01: Japanese farmer, 61 years old, short cropped grey hair, CLEAN-SHAVEN with no beard, no moustache and no stubble, lying face-down and motionless on the ground, clearly dead and NOT sleeping, seen from behind and slightly above so that his back, buttocks and the backs of both thighs face the camera and his face is turned away and hidden. His faded dark green work jacket is shredded into hanging strips and his brown work trousers are torn wide open across the seat and the backs of both thighs; through the torn cloth the buttocks and both thighs are drawn as large dark hollowed patches with ragged jagged edges, the muscle visibly missing, in simple flat cartoon shading, nothing red and nothing stained. One black rubber boot is missing. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-15 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-15: Japanese volunteer firefighter in his mid-50s, short black hair greying at the sides, square weathered face, navy volunteer fire brigade jacket with plain silver reflective bands and no lettering, dark grey trousers, black rubber boots, white cotton gloves, CLEAN-SHAVEN with no beard, no moustache and no stubble. He is down on one knee, leaning forward and lowering a folded jacket with both hands toward the ground just outside the bottom edge of the frame, while his face is turned sharply away over his shoulder, eyes screwed shut into tight creases, teeth bared, eyebrows knotted in pain. Only the folded jacket as a prop, nothing else around him. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 022
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. SIX Japanese men — exactly six, count them 1, 2, 3, 4, 5, 6 — in one loose row, all facing the same point beyond the right edge of the frame. Left to right: 1) a Japanese man in his 30s in a dark green fire brigade jacket with plain reflective bands and no lettering, one arm cocked back high with a stone in his fist, mouth stretched wide open in a shout with every tooth showing; 2) a Japanese man in his 50s in a beige work jacket, both arms raised over his head, head tipped back, shouting; 3) a Japanese man in his 60s in a checked shirt and vest, crouched low with one hand scooping a stone off the ground, the other pointing forward; 4) a heavyset Japanese man in his 40s in a grey sweatshirt with a white towel around his neck, one arm swung fully forward the instant after pitching a stone, mouth open in a roar; 5) a tall thin Japanese man in his 20s in a blue windbreaker and a baseball cap, a stone in each hand, one arm cocked back, eyebrows shot up and together; 6) a short Japanese man in his 50s in a brown quilted vest and a flat cap, both hands cupped around his mouth, shouting, face flushed red. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All are pitching stones or shouting toward the same point off the right edge, none of them retreating. Do NOT draw fewer than six men. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. Generate 1 image.
```
→ 背景再使用: 033
...
キャラプロンプト（1:1）:
```
[Generic group](CHAR-14 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) a Japanese man in his 50s in a navy volunteer fire brigade jacket with plain reflective bands and no lettering, carrying a folded stretcher under one arm; 2) a Japanese police officer in his 30s in a plain dark blue uniform with no crest, no emblem and no lettering, holding a notebook; 3) CHAR-14: Japanese hunter in his mid-50s, olive-brown hunting jacket, dark green trousers, faded orange cap, a plain bolt-action hunting rifle held across his body with the whole length of the rifle visible across the frame; 4) a Japanese hunter in his 60s in a grey hunting vest and a brown cap, rifle slung on one shoulder; 5) a Japanese man in his 40s in a dark green fire brigade jacket with a coil of rope. Directly behind this front row stand two more rows of men, partly hidden by the front row so that only their heads, shoulders and upper chests show, drawn a little smaller because they are farther back: about ten more Japanese men in navy or dark green fire brigade jackets and plain dark blue police uniforms with no crest and no emblem, and four more Japanese hunters in caps with rifle barrels rising above their shoulders — roughly twenty people in all. Every face in the back rows is different too, with different ages, hairstyles, caps and helmets. Do NOT draw only five people. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have eyebrows driven down hard and pulled together, eyes narrowed to a hard unblinking stare, mouths pressed into flat grim lines. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-01 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-01: Japanese farmer, 61 years old, short cropped grey hair, CLEAN-SHAVEN with no beard, no moustache and no stubble, lying still on his back, clearly deceased and NOT sleeping. A plain white sheet covers his whole body from the shoulders down to the feet, so that only his head and neck show above its folded edge. His face is pale bluish-white, eyes closed, mouth closed in a flat still line, and his head and neck are completely clean and unmarked. NOT smiling, NOT peaceful-looking. He has a large head, a short compact body under the sheet, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body, seen from slightly above and from the side. Transparent background, real alpha transparency. 1:1 aspect ratio. No blood, no gore, no open wounds. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-01 再利用)(CHAR-11 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Seen in full side profile, both figures facing right. Right side of the image: CHAR-01: Japanese farmer, 61 years old, faded dark green work jacket, brown work trousers, black rubber boots, woven basket on his back, CLEAN-SHAVEN, mid-stride walking toward the right edge of the frame, head and body still facing forward away from the bear, eyes going wide and mouth opening in a sudden gasp, NOT turning around and NOT looking back. Left side of the image: CHAR-11: adult male Japanese black bear, 140cm body length and 84kg, glossy jet-black coat, white crescent-moon chest patch, large round ears, short blunt muzzle, NO shoulder hump, launching forward low from all fours at the man's back, body stretched out horizontally, both front paws lifted and reaching toward the basket on his back, ears flattened, mouth open in a snarl with the teeth showing. NOT standing upright on two legs. Both have large heads, short compact torsos and short stubby limbs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 028（そのまま）
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-14: Japanese hunter in his mid-50s, olive-brown hunting jacket, dark green trousers, rubber boots, faded orange cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, standing alone and holding a single blank sheet of paper up in front of him with both hands, eyebrows driven down hard and pulled together, mouth pressed into a flat grim line with the jaw muscles tight. Only the blank paper as a prop, nothing else around him, and no other person in the image. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用)(CHAR-16 再利用)(CHAR-17 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Four Japanese men actively searching, spread out in a loose line, each doing something different, seen from the side and in three-quarter view. Left to right: 1) CHAR-14: Japanese hunter in his mid-50s, olive-brown hunting jacket, faded orange cap, a plain bolt-action rifle held low with the muzzle pointing at the ground, bending forward to study the ground at his feet; 2) CHAR-16: Japanese hunter in his mid-60s, grey quilted hunting vest, brown cloth cap, canvas satchel, one hand shading his eyes as he scans far up the slope; 3) CHAR-17: Japanese villager in his early 40s, khaki work jacket, white towel headband, pushing tall bamboo grass aside with a long wooden pole; 4) a Japanese man in his 30s in a navy windbreaker with a coil of rope on his hip, pointing ahead with one arm. All CLEAN-SHAVEN. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. Tense, focused expressions. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1・ハンター3人）:
```
(CHAR-14 再利用)(CHAR-16 再利用)(CHAR-17 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) CHAR-14: Japanese hunter in his mid-50s, olive-brown hunting jacket, faded orange cap, standing with both hands hanging at his sides and his head turning slowly to one side in a clear no, mouth pressed into a flat grim line; 2) CHAR-16: Japanese hunter in his mid-60s, grey quilted hunting vest, brown cloth cap, pulling off a white cotton glove, eyes narrowed; 3) CHAR-17: Japanese villager in his early 40s, khaki work jacket, white towel headband, arms folded, looking down at the ground and shaking his head. All CLEAN-SHAVEN. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. Only the glove as a prop, nothing else around them. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用)(CHAR-16 再利用)(CHAR-17 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) CHAR-14: Japanese hunter in his mid-50s, olive-brown hunting jacket, dark green trousers, rubber boots, his faded orange cap crushed hard in both fists at his waist, head bowed, eyes squeezed shut, teeth gritted, eyebrows knotted tight; 2) CHAR-16: Japanese hunter in his mid-60s, grey quilted hunting vest, brown cloth cap, one fist clenched and trembling at his side, biting his lower lip, looking down at the ground with wet eyes; 3) CHAR-17: Japanese villager in his early 40s, khaki work jacket, white towel headband, one hand pressed over his eyes, shoulders hunched, jaw clenched. All CLEAN-SHAVEN. All three show bitter frustration and regret — NOT calm, NOT neutral, NOT angry shouting, NOT crying loudly. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. Only the cap as a prop, nothing else around them. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. Generate 1 image.
```
→ 背景再使用: 053
...
```
The foot of a large old walnut tree at the edge of a forested slope in Yamagata, Japan at first light in late October, seen from about eight metres back. At the base of the trunk a Japanese woman in her late 50s lies motionless on her side in the dry leaves with her back to the camera, her face turned away and completely hidden, no face visible, wearing a faded blue headscarf, a mustard-yellow work smock and dark grey monpe trousers, one black rubber boot slipped half off. Tall dry grass in the foreground partly screens her, so that only her shoulder, headscarf and legs show. A small woven basket lies tipped over nearby with walnuts spilled in a wide arc, and the leaf litter around her is pressed flat and rumpled. Yellowing leaves overhead, autumn gold and rust on the slope behind, thin mist between the trunks. Late October dawn, cool light, dim in the shade but NOT pure black — the woman, the basket and the trunk stay clearly readable. No snow anywhere, no frost, no ice, no winter. Somber, still and silent. No blood, no wounds, no gore. Photorealistic, shot on RED camera, 50mm lens. Documentary drama style. 16:9 aspect ratio. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
(CHAR-03 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, slightly chibi proportions, children's animation style. CHAR-03: Japanese woman, 59 years old, faded blue headscarf, mustard-yellow work smock, dark grey monpe trousers, black rubber boots, lying on her back on the ground, motionless, clearly dead and NOT sleeping, seen from slightly above at a three-quarter angle so that her whole body is visible. Her head and neck are completely clean and unmarked: face pale bluish-white, eyes closed, mouth slack, headscarf still in place. The right side of her smock over the chest is torn open and the area beneath is drawn as a large dark hollowed patch with ragged edges; both legs of her monpe trousers are ripped wide open across the thighs, each thigh showing a large dark hollowed patch; her right sleeve is shredded and the right forearm shows the same dark hollowed patch. Simple flat cartoon shading, nothing red and nothing stained. Her expression is NOT peaceful, NOT smiling and NOT relaxed. She has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw her with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no gore. Generate 1 image.
```
→ 背景再使用: 045
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A single Japanese man in his early 20s, in a grey windbreaker and jeans, CLEAN-SHAVEN with no beard, no moustache and no stubble, walking away from the camera with a heavy adult-sized bundle carried securely on his back, leaning forward under its weight with both forearms hooked backward to support it. The bundle is a deceased person completely enclosed in opaque white cloth from head to foot; the cloth stays closed, with no face, hands, feet or any part of the contents visible. Strict rear view: only the carrier's back and the back of his head face the camera, no face visible. Exactly one carrier; no other carriers, no stretcher, no poles, no group holding the cloth. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body, including the whole carrier and the entire bundle. Fully transparent background with real alpha transparency, no painted checkerboard. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 084
...
キャラプロンプト（1:1）:
```
(CHAR-07 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-07: Japanese man, 63 years old, still broad-shouldered but thickened with age, sparse thin grey hair, deeply lined face, sunken cheeks, sagging skin at the jaw, age spots on the hands, CLEAN-SHAVEN with no beard, no moustache and no stubble. NOT middle-aged. Wearing a moss-green fleece work jacket, brown work trousers and black rubber boots, standing with both hands loose at his sides and shoulders sunk, speaking quietly while recalling people he knew. Eyebrows drawn slightly upward at their inner ends, eyes lowered with heavy eyelids, mouth barely parted in a downturned line with neither corner raised. A deeply saddened, subdued expression. NOT smiling, NOT grinning, NOT cheerful, NOT angry, NOT shouting. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-10 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-10: Japanese university professor, man in his late 50s, slim, greying hair thinning at the front, round glasses, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a beige corduroy jacket over a white shirt, a dark knitted tie and grey trousers, no real institution name, no crest, no emblem and no logo on anything he wears or holds, standing and holding a rolled sheet of blank paper in one hand down at his side, the other hand open at chest height, delivering one clear firm statement. Eyebrows level and relaxed with no furrow between them, eyes open at their normal width and looking steadily forward, mouth narrowly parted in a straight level line, lips firm with neither corner raised. NOT smiling, NOT grinning, NOT angry, NOT shouting, NOT startled. Only the rolled paper as a prop, nothing else around him. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-10 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-10: Japanese university professor, man in his late 50s, slim, greying hair thinning at the front, round glasses, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a beige corduroy jacket over a white shirt, a dark knitted tie and grey trousers, no real institution name, no crest, no emblem and no logo on anything he wears or holds, leaning forward from the waist with one palm turned toward the viewer at chest height and the other hand pointing down at the ground, firmly urging action through his posture and measured hand gesture. Eyebrows relaxed with no furrow between them, eyes open at their normal width and fixed attentively forward, mouth only slightly open for firm speech with relaxed jaw and no bared teeth. NOT angry, NOT shouting, NOT scowling, NOT smiling, NOT grinning, NOT frightened. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 091
...
静止画プロンプト（16:9・フォトリアル）:
```
Close view of a wild grapevine twisted around a tree at the edge of a wood in Yamagata, Japan in late October with its curling tendrils and yellowing leaves completely bare of fruit, not a single bunch anywhere on the vine, and beside it, equally sharp and clearly identifiable, a walnut branch with long pinnate compound leaves made up of paired serrated oval leaflets and a terminal leaflet, green turning yellow, and several bare branched fruit-cluster stalks with empty attachment points where walnuts would hang. These are recognisable walnut leaves and empty walnut fruit clusters, not generic twigs; no walnuts remain on any cluster. Dry leaf litter below with nothing fallen on it. Autumn gold and rust, pale overcast sky through the branches. Late October, cool flat light. No snow anywhere, no frost, no ice, no winter. Emptiness where food should be. Photorealistic, shot on RED camera, 85mm lens, shallow depth of field. Documentary style. 16:9 aspect ratio. No people, no humans visible. No blood, no wounds, no gore. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) CHAR-14: Japanese hunter in his mid-50s, stocky and weathered, short black hair going grey at the sides under a faded orange cap, deeply lined face, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing an olive-brown hunting jacket, dark green trousers and rubber boots, plain bolt-action rifle held ready across his body with the whole length of the rifle visible across the frame; 2) a Japanese hunter in his 60s in a grey hunting vest and brown cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, rifle held low, head turned to scan the other way; 3) a Japanese hunter in his 40s in a dark green jacket and knitted cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, one arm raised signalling to the side. All have eyebrows driven down hard and pulled together, eyes narrowed to a hard unblinking stare, mouths pressed into flat grim lines. NOT smiling, NOT grinning. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-11 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-11: adult male Japanese black bear, 140cm body length and 84kg, glossy jet-black coat, white crescent-moon chest patch, large round ears, short blunt muzzle, NO shoulder hump, walking calmly ON ALL FOURS away from the camera, its spine nearly horizontal and torso held low in a natural four-legged gait. Strict rear view: only its back, rump and hind legs face the camera, its face is hidden, the front paws remain low and partly visible beyond the hind legs, no paw raised above shoulder height. Its head stays low and points away over the crest, unhurried steady stride. NOT standing upright, NOT balancing on its hind legs, NOT reared up. Not aggressive, not fleeing in panic. NOT reared up, NOT on two legs. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-04 再利用)(CHAR-05 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) CHAR-04: Japanese woman, 61 years old, of average build, short permed greying hair with clearly white-grey curls, round friendly face with soft laugh lines, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a soft red-checked flannel shirt, a beige field apron, dark brown trousers and grey trainers, with white cotton work gloves, carrying a woven basket, eyebrows relaxed, eyes gently open and mouth in a warm everyday smile, NOT angry, NOT startled, NOT grinning broadly, no brown hair and no straight cropped haircut; 2) CHAR-05: Japanese man in his early 60s, lean and wiry, short greying hair, deeply lined face, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a navy zip-up work jacket, khaki trousers, black rubber boots and a grey cap, carrying two empty sacks over one shoulder; 3) a Japanese man in his 30s in a brown blouson and jeans, carrying a long bamboo pole; 4) a Japanese woman in her 30s in a mustard cardigan and dark trousers, holding a thermos; 5) a Japanese teenage boy in a grey sweatshirt and trainers, hands in his pockets. All five people are CLEAN-SHAVEN with no beard, no moustache and no stubble. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-04 再利用)(CHAR-05 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Five separate Japanese character cutouts at different positions within the square, with wide empty gaps at least one body-width between their outlines. No central cluster, no touching or overlapping figures, no shared focus. Numbered positions: 1) far lower left, CHAR-04: Japanese woman, 61 years old, of average build, short permed greying hair with clearly white-grey curls, round friendly face with soft laugh lines, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a soft red-checked flannel shirt, a beige field apron, dark brown trousers and grey trainers, with white cotton work gloves, crouched low and picking up a chestnut with one gloved hand, facing left; 2) upper left, a Japanese woman in her 30s in a mustard cardigan and dark trousers, CLEAN-SHAVEN with no beard, no moustache and no stubble, standing with one arm extended and looking to the upper left; 3) lower right, CHAR-05: Japanese man in his early 60s, lean and wiry, short greying hair, deeply lined face, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a navy zip-up work jacket, khaki trousers, black rubber boots and a grey cap, bent over with a sack open at his feet, facing right; 4) upper right, a Japanese man in his 30s in a brown blouson and jeans, CLEAN-SHAVEN with no beard, no moustache and no stubble, kneeling on one knee with his back turned fully away; 5) near the lower centre, far apart from the others, a Japanese teenage boy in a grey sweatshirt and trainers, CLEAN-SHAVEN with no beard, no moustache and no stubble, squatting with both hands down, facing the viewer but looking at his own hands. Each face has relaxed brows, eyes looking at that person's own task, and a quiet closed mouth, NOT angry, NOT grinning, NOT frightened. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 106
...
キャラプロンプト（1:1）:
```
(CHAR-05 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-05: Japanese man in his early 60s, lean and wiry, short greying hair fully exposed, deeply lined face, navy zip-up work jacket, khaki trousers, black rubber boots, bareheaded with NO hat and NO cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, stopped dead mid-stride with both arms flung out for balance, body rocked backward, one heel skidding, face drained bone white, jaw hanging slack, eyebrows shot high upward, eyes bulging almost out of his head with the pupils shrunk to tiny dots. NOT smiling, NOT grinning, NOT angry. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 110
...
キャラプロンプト（1:1）:
```
(CHAR-05 再利用)(CHAR-11 再利用)(CHAR-04 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Two clearly separated depth planes with a broad empty gap between them. Foreground at the lower left: 1) CHAR-05: Japanese man in his early 60s, lean and wiry, short greying hair, deeply lined face, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a navy zip-up work jacket, khaki trousers, black rubber boots and a grey cap, standing with both empty hands held open and low in front of him, nothing in either hand, one foot half a step back, eyebrows raised, eyes stretched wide, mouth open with the teeth showing, NOT smiling, NOT grinning, NOT angry; 2) far behind him at the upper right, CHAR-11: adult male Japanese black bear, 140cm body length and 84kg, glossy jet-black coat, white crescent-moon chest patch, large round ears, short blunt muzzle, NO shoulder hump, planted ON ALL FOURS facing him with its chest and both shoulders squared toward him, head dropped low between bunched shoulders, ears flattened right back against the skull, mouth wrenched wide open in a roaring snarl with the teeth clearly showing, the fur along its neck and shoulders bristled up into a raised ridge, claws spread. It is NOT calm, NOT curious and NOT gentle — it reads as furious at a glance. NOT reared up, NOT on two legs. 3) CHAR-04: Japanese woman, 61 years old, soft red-checked flannel shirt, beige field apron, dark brown trousers, grey trainers, short permed greying hair, lying motionless on her side on the ground directly in front of the bear's front paws, her face turned away and hidden, one arm flung out, a woven basket tipped over beside her, in the same far depth plane as the bear. The bear stays several metres away, its image visibly smaller because it is deeper in the scene, with a broad transparent strip between the man and the bear. It is NOT beside him, NOT touching him and NOT pouncing toward his body. Both have large heads, short compact torsos and short stubby limbs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 106
...
キャラプロンプト（1:1）:
```
(CHAR-04 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, slightly chibi proportions, children's animation style. CHAR-04: Japanese woman, 61 years old, soft red-checked flannel shirt, beige field apron, dark brown trousers, grey trainers, short permed greying hair, lying face-down and motionless on the ground, clearly dead and NOT sleeping, seen from behind and slightly above so that her back, lower back, buttocks and the backs of both calves face the camera and her face is completely hidden. Her head and neck are clean and unmarked. Her trousers are torn wide open from the lower back across the buttocks, and both trouser legs are ripped open across the backs of the calves; through the torn cloth the lower back, buttocks and both calves are drawn as large dark hollowed patches with ragged jagged edges, the muscle visibly missing, in simple flat cartoon shading, nothing red and nothing stained. She has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw her with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no gore. Generate 1 image.
```
→ 背景再使用: 045
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) CHAR-14: Japanese hunter in his mid-50s, stocky and weathered, short black hair going grey at the sides under a faded orange cap, deeply lined face, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing an olive-brown hunting jacket, dark green trousers and rubber boots, plain bolt-action rifle slung muzzle-down on one shoulder, striding forward; 2) a Japanese hunter in his 60s in a grey hunting vest, brown cap and rubber boots, CLEAN-SHAVEN with no beard, no moustache and no stubble, with a plain bolt-action hunting rifle slung muzzle-down over his shoulder, pulling on a white cotton glove; 3) a Japanese hunter in his 40s in a dark green jacket and knitted cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, with a plain bolt-action hunting rifle slung muzzle-down over his shoulder, carrying a canvas cartridge belt over one arm; 4) a Japanese hunter in his 30s in a khaki jacket and orange armband, CLEAN-SHAVEN with no beard, no moustache and no stubble, gripping the strap of his own plain bolt-action hunting rifle slung muzzle-down over his shoulder, jumping down from an unseen tailgate. Directly behind these four stand two more rows of Japanese hunters, partly hidden by the front row so that only their heads, shoulders and the muzzles of slung rifles show, drawn a little smaller because they are farther back: nine more men in caps, hunting vests and jackets of different colours — thirteen hunters in all. Every face in the back rows is different. Do NOT draw only four people. Exactly four hunters in the front row, each with a visibly separate rifle, all rifles in the same cartoon style. NOT smiling, NOT grinning. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have eyebrows driven down hard and pulled together, eyes narrowed to a hard unblinking stare, mouths pressed into flat grim lines with the jaw muscles tight. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-14: Japanese hunter in his mid-50s, olive-brown hunting jacket, dark green trousers, rubber boots, faded orange cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, standing side-on with a plain bolt-action hunting rifle raised to his shoulder and his cheek down on the stock, THE WHOLE LENGTH OF THE RIFLE VISIBLE across the frame pointing toward the right edge, at the exact instant of firing: a puff of pale grey smoke bursting from the muzzle, the rifle butt driven back into his shoulder, one eye narrowed to a hard unblinking stare, mouth pressed into a flat grim line with the jaw muscles tight. Only the rifle and the muzzle smoke as props, nothing else around him. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
A wide view across a forested slope in Yamagata, Japan in late October at the instant of a rifle shot: a scatter of small birds bursting up out of the bare branches all across the slope, wings caught mid-beat, dry leaves shaken loose and drifting. Autumn gold and rust, low afternoon light. Late October afternoon, warm flat light. No snow anywhere, no frost, no ice, no winter. No people, no figures, no humans visible, no animals on the ground. Empty landscape only. Photorealistic, shot on RED camera, 50mm lens. Documentary style. 16:9 aspect ratio. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
(CHAR-11 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-11: adult male Japanese black bear, 140cm body length and 84kg, glossy jet-black coat, white crescent-moon chest patch, large round ears, short blunt muzzle, NO shoulder hump, seen from the side with its right flank toward the camera, caught in the instant of going down: its front legs still planted but its hind legs buckling and folding under it, its body sagging toward the ground, head thrown back with the mouth open and eyes squeezed shut, ears flattened, a small tuft of fur puffing off the right side of its belly where the shot struck, nothing red and nothing stained. It is a four-legged animal collapsing ON ALL FOURS: NOT reared up, NOT on two legs, NOT lying flat yet, NOT belly-up. Full body. White background. 1:1 aspect ratio. No blood, no gore. Generate 1 image.
```
→ 背景再使用: 134
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Exactly four Japanese people in two separate groups of two, the left pair on the far left and the right pair on the far right, with a wide transparent gap down the centre. Left group: 1) a man in his 70s in a brown work jacket and flat cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, left arm extended with the index finger pointing toward the upper left; 2) a woman in her 50s in a green cardigan, CLEAN-SHAVEN with no beard, no moustache and no stubble, turned toward the first man, right index finger pointing leftward. Right group: 3) a man in his 40s in a grey work coat, CLEAN-SHAVEN with no beard, no moustache and no stubble, right arm extended and pointing toward the upper right; 4) CHAR-14: Japanese hunter in his mid-50s, stocky and weathered, short black hair going grey at the sides under a faded orange cap, deeply lined face, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing an olive-brown hunting jacket, dark green trousers and rubber boots, his plain bolt-action rifle slung on one shoulder in the same cartoon style, free hand pointing rightward. The two pairs indicate clearly different directions; none points at the centre or at the other pair. All have eyebrows drawn together, attentive eyes and mouths partly open in discussion, NOT smiling, NOT grinning. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-17 再利用)(CHAR-15 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) CHAR-17: Japanese villager, man in his early 40s, broad and muscular, round face, short black hair under a white towel tied as a headband, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a khaki work jacket with the sleeves pushed up, dark navy work trousers and black split-toe tabi work boots, frozen mid-step with one arm thrust out pointing hard off to the side, head turned back toward the man behind him, eyebrows raised, eyes stretched wide and mouth open speaking urgently; 2) CHAR-15: Japanese volunteer firefighter, man in his mid-50s, stocky build, short black hair greying at the sides, square weathered face, thick eyebrows, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a navy volunteer fire brigade jacket with plain silver reflective bands and no lettering, dark grey trousers, black rubber boots and white cotton gloves, following the first man's pointing arm with his eyes, one hand raised to shade them, brows slightly raised and mouth narrowly parted in alert concentration. Neither is smiling, grinning or angry. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-14 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-14: Japanese hunter in his mid-50s, stocky and weathered, short black hair going grey at the sides under a faded orange cap, deeply lined face, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing an olive-brown hunting jacket, dark green trousers and rubber boots, standing empty-handed, both arms hanging loosely at his sides with open relaxed hands, leaning slightly forward to look down, shoulders visibly drooping and head lowered. Eyebrows raised slightly at their inner ends without an angry furrow, eyes cast downward beneath heavy eyelids, mouth closed with both corners turned down and jaw relaxed. A disappointed, dejected expression after finding nothing. NOT eager, NOT triumphant, NOT smiling, NOT grinning, NOT angry. No cage, no miniature trap and no object in either hand. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A Japanese forensic physician, man in his 40s with a broad square face, short straight black hair and no glasses, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a plain white lab coat with no crest, no emblem and no logo, standing and holding an open bound journal in one hand while the thumb and forefinger of the other hand lift one page at its edge, visibly turning that page of the medical journal, earnest and level expression, eyebrows relaxed with no furrow between them, eyes open at their normal width and focused on the journal, mouth closed in a soft even line. NOT smiling, NOT grinning, NOT angry, NOT frightened, NOT grim. Only the journal as a prop, nothing else around him. The open pages carry no lettering and no readable characters. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 175
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A Japanese wildlife researcher, man in his 50s in a khaki field vest over a checked shirt and round glasses, CLEAN-SHAVEN with no beard, no moustache and no stubble, standing with both forearms crossed in front of his chest in a clear refusal, both palms turned toward the viewer, head tilted slightly to one side in a measured denial, calm and composed. Eyebrows relaxed and level with no furrow between them, eyes open at their normal width and looking steadily forward, mouth narrowly parted in a soft level speaking shape with jaw relaxed. No sweat drops or sweat marks. NOT panicked, NOT startled, NOT shouting, NOT smiling, NOT grinning, NOT angry, NOT frightened. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 082
...
キャラプロンプト（1:1）:
```
(CHAR-11 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-11: adult male Japanese black bear, 140cm body length and 84kg, glossy jet-black coat, white crescent-moon chest patch, large round ears, short blunt muzzle, NO shoulder hump, stocky but slender frame, its shoulder no higher than an adult's waist and clearly much smaller than a grizzly or brown bear. Sitting back on its haunches in a natural quadruped resting posture, rump down and both front paws planted flat in front, forelegs straight, remaining completely motionless with an unblinking watchful gaze and mouth closed. NOT reared up, NOT on two legs, NOT posed like a person. This is an unnervingly still animal, not a roaring or lunging pose. Its back is toward one fixed point behind it; its head faces the viewer in a three-quarter view while its body stays planted. Only the bear, no other figure or object, no human remains. Full body. Fully transparent background with real alpha transparency. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-11 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A left-right comparison in one square image: exactly six Japanese village men occupy the left half, and one motionless bear occupies the right half, separated by a wide transparent gap with no overlap. The six men are staggered at varied heights and angles, not in an even row. Left half, numbered from left to right: 1) a tall lean Japanese man in his 30s, short cropped black hair, narrow face, dark green fire brigade jacket with plain reflective bands and no lettering, dark trousers and black boots, right arm cocked back with a stone, facing right, CLEAN-SHAVEN with no beard, no moustache and no stubble; 2) a short stocky Japanese man in his 50s, receding grey hair, broad square face, beige work jacket, brown trousers and rubber boots, arm extended just after pitching a stone to the right, CLEAN-SHAVEN with no beard, no moustache and no stubble; 3) a medium-height thin Japanese man in his 60s, sparse white hair, long lined face, checked shirt, brown vest, khaki trousers and black boots, crouched low to pick up a stone with his other hand pointing right, CLEAN-SHAVEN with no beard, no moustache and no stubble; 4) a very tall broad Japanese man in his 40s, short black hair under a white towel headband, round face, navy work jacket, dark grey trousers and split-toe work boots, left arm bent back with a stone, leaning forward toward the right, CLEAN-SHAVEN with no beard, no moustache and no stubble; 5) a small wiry Japanese man in his 20s, thick wavy black hair, oval face, grey windbreaker, blue jeans and white trainers, right arm following through from a stone cast to the right, CLEAN-SHAVEN with no beard, no moustache and no stubble; 6) a medium-tall heavyset Japanese man in his late 50s, grey hair under a brown cloth cap, wide cheeks, muted red work shirt, dark green trousers and leather boots, stone lifted in his left hand and body turned toward the right, CLEAN-SHAVEN with no beard, no moustache and no stubble. All six are pitching or preparing to pitch stones toward the right, eyebrows raised and pulled together, eyes fixed on the bear, mouths open calling out. NOT smiling, NOT grinning. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Right half: CHAR-11: adult male Japanese black bear, 140cm body length and 84kg, glossy jet-black coat, white crescent-moon chest patch, large round ears, short blunt muzzle, NO shoulder hump, stocky but slender frame, its shoulder no higher than an adult's waist and clearly much smaller than a grizzly or brown bear. Sitting back on its haunches in a natural quadruped resting posture, rump down and both front paws planted flat in front, forelegs straight, remaining completely motionless with an unblinking watchful gaze and mouth closed. NOT reared up, NOT on two legs, NOT posed like a person. This is an unnervingly still animal, not a roaring or lunging pose. Small stones are in the gap, none touching the animal. Only the stones as props, nothing else around them. No bodies, no remains. Full body, all six men and the whole bear in frame. Fully transparent background with real alpha transparency. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 184
...
静止画プロンプト（16:9・フォトリアル）:
```
A single white enamel basin heaped with chestnut kernels and shell fragments, set alone at the centre of a plain steel workbench in a rural Japanese work yard in Tozawa, Yamagata, Japan at night in autumn, late October. A still frozen frame: the basin and every chestnut are at rest, with no hands or tools beside them. One bare bulb lights the pile; the surroundings are dim but NOT pure black — the entire basin, heaped chestnuts and edge of the workbench stay clearly readable. No people, no humans visible, no animals. No blood, no wounds, no gore. No lettering, no readable characters anywhere. No real institution name, no crest, no emblem, no logo. No snow anywhere, no frost, no ice, no winter. Nothing red and nothing stained. Photorealistic, shot on RED camera, 85mm lens, shallow depth of field. Documentary evidence photography style. 16:9 aspect ratio. Generate 1 image.
```
Google Flow動画プロンプト:
```
...
キャラプロンプト（1:1）:
```
(CHAR-01 再利用)(CHAR-03 再利用)(CHAR-04 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Three Japanese people standing in a row side by side, all seen from directly behind so that only their backs, waists and legs face the camera and none of their faces are visible, all standing upright and still with their arms slightly away from their sides, drawn at the same scale with their feet on the same ground line. Left to right: 1) CHAR-01: Japanese farmer, 61 years old, weathered sun-darkened face, deeply lined forehead, short cropped grey hair, CLEAN-SHAVEN with no beard, no moustache and no stubble, faded dark green work jacket, brown work trousers, black rubber boots, beige towel around his neck and a woven bamboo basket clearly worn on his back, bareheaded with NO hat and NO cap; 2) CHAR-03: Japanese woman, 59 years old, sturdy and short, greying hair under a faded blue headscarf, lined cheerful face, CLEAN-SHAVEN with no beard, no moustache and no stubble, mustard-yellow work smock, dark grey monpe trousers, black rubber boots, carrying a small woven basket in one hand; 3) CHAR-04: Japanese woman, 61 years old, of average build, short permed greying hair with clearly white-grey curls, round friendly face with soft laugh lines, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a soft red-checked flannel shirt, a beige field apron, dark brown trousers and grey trainers, with white cotton work gloves, hair left short and permed, NOT tied up, no bun. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 045
...
キャラプロンプト（1:1）:
```
(CHAR-12 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Two figures locked together on the ground, seen from the side. CHAR-12: a large adult Japanese black bear, about 150cm body length and about 110kg, glossy jet-black coat, large round ears, short blunt muzzle, NO shoulder hump, clearly much smaller than a grizzly or a brown bear, lying ON ALL FOURS on top of a Japanese man's back with its full weight pressing him flat to the ground, its jaws clamped onto the back of his shoulder and NOT letting go, ears flattened right back against the skull, eyes narrowed and locked on, the fur along its neck and shoulders bristled up into a raised ridge, claws spread. It is NOT calm, NOT curious and NOT gentle — it reads as ferocious at a glance. The man beneath it: a Japanese man in his 50s in a brown work jacket and dark trousers, face-down, his face turned away and hidden, arms spread on the ground. The bear is NOT reared up, NOT on two legs. Nothing red and nothing stained. Both have large heads, short compact torsos and short stubby limbs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-11 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) a Japanese adult in plain dark work clothes and rubber boots, CLEAN-SHAVEN with no beard, no moustache and no stubble, lying on the ground on their back with both knees drawn up and both feet kicking out hard toward the right of the frame, both arms braced behind on the ground, eyebrows raised and drawn together, mouth stretched wide open in a shout, eyes screwed shut into tight creases, NOT smiling, NOT grinning; 2) CHAR-11: adult male Japanese black bear, 140cm body length and 84kg, glossy jet-black coat, white crescent-moon chest patch, large round ears, short blunt muzzle, NO shoulder hump, ON ALL FOURS pressing in from the right toward the kicking feet, head dropped low between bunched shoulders, ears flattened right back against the skull, mouth open in a snarl with the teeth clearly showing, the fur along its neck bristled up into a raised ridge, claws spread. It is NOT calm, NOT curious and NOT gentle. NOT reared up, NOT on two legs. At full extension, both boot tips stop well before the bear's open mouth; a clearly visible transparent gap at least one boot-length wide separates every part of the boots from the lips and teeth. No boot overlaps the mouth, nothing is between the jaws and nothing is being bitten. Both have large heads, short compact torsos and short stubby limbs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 193
...
キャラプロンプト（1:1）:
```
(CHAR-11 再利用)(CHAR-12 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Two Japanese black bears standing side by side, both ON ALL FOURS in the same neutral side-on pose, drawn at the same scale with their feet on the same ground line so the heights can be compared directly. Left to right: 1) CHAR-11: a FULLY GROWN adult male, 140cm body length and 84kg, NOT a cub, NOT a juvenile, NOT small — only slightly smaller than the bear beside it, about nine-tenths of its length and height, the top of its back only a hand's width lower than the other bear's back, its head carried at normal walking height, a little lower than the other bear's head; 2) CHAR-12: a larger adult, about 150cm body length and about 110kg, broader across the chest with a coarser shaggier coat, its head carried noticeably higher. Both have glossy jet-black coats, white crescent-moon chest patches, large round ears, short blunt muzzles and NO shoulder hump, and both are clearly much smaller than a grizzly or a brown bear. Neither is aggressive; both are resting quietly. NOT reared up, NOT on two legs. Do NOT draw the left bear as a tiny cub next to a big adult; the two are nearly the same size and only the right one is a little bigger. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 106
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A Japanese wildlife researcher, man in his 50s in a khaki field vest over a checked shirt and round glasses, CLEAN-SHAVEN with no beard, no moustache and no stubble, standing with one hand at chest height, wrist rotated so exactly two extended fingers point horizontally to the side, with the fingers together and the other fingers folded, the hand seen edge-on, NOT a V sign, NOT a peace sign, NOT a victory pose, the other hand holding a closed notebook at his side, calm and composed, eyebrows relaxed and level with no furrow between them, eyes open at their normal width, mouth narrowly parted in a soft even line to explain. NOT smiling, NOT grinning, NOT cheerful, NOT angry, NOT startled. Only the notebook as a prop, nothing else around him. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 082
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A still-life cutout of several thick stacks of prefectural reports in plain cream paper folders, lying in an uneven arrangement with one long folded sheet opened flat in front of the stacks. The papers contain small rows of indistinct printed marks, no readable titles. Only the documents as props, nothing else around them, flat lower edges ready to rest on a desk in a separate background. These are paper objects, not anthropomorphic characters. Full body of each object entirely in frame. White background. 1:1 aspect ratio. No people, no figures, no humans, no hands, no faces, no human-shaped objects. No blood, no wounds, no gore. No lettering, no readable characters anywhere. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A still-life cutout of thick stacks of prefectural reports in plain cream paper folders, lying in an uneven arrangement, a long sheet of paper opened flat before them and a ballpoint pen resting beside its bottom edge. The latest loose page lies at the front, ready for an additional entry. Only the documents and pen as props, nothing else around them, flat lower edges ready to rest on a desk in a separate background. These are paper objects, not anthropomorphic characters. Full body of each object entirely in frame. White background. 1:1 aspect ratio. No people, no figures, no humans, no hands, no faces, no human-shaped objects. No blood, no wounds, no gore. No lettering, no readable characters anywhere. Generate 1 image.
```
→ 背景再使用: 206
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A Japanese hunter in his 50s in a modern blaze-orange hunting vest over a grey softshell jacket, dark trousers and boots, a plain cap, standing and holding a small handheld radio up near his mouth with one hand while the other rests on a plain bolt-action hunting rifle slung muzzle-down on his shoulder, mouth open speaking into the radio, eyebrows driven down hard and pulled together, eyes narrowed to a hard unblinking stare, mouth otherwise pressed into a flat grim line. At his feet lies a dead Japanese black bear, about 120cm body length and about 80kg, glossy jet-black coat, large round ears, short blunt muzzle, NO shoulder hump, lying PRONE flat on its belly exactly the way a four-legged animal drops, all four legs splayed out limp on the ground, head down with the chin resting on the ground, BOTH EYES DRAWN AS SIMPLE BLACK X MARKS — two crossed straight lines for each eye, NOT belly-up, NOT posed like a person. Only the radio, the rifle and the bear, nothing else around them. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) a Japanese hunter in his late 30s in an olive-brown hunting jacket, dark trousers, rubber boots and a brown cloth cap, thick black hair, CLEAN-SHAVEN with no beard, no moustache and no stubble, crouched on one knee with one hand pointing down at the ground beside him and his head turned up over his shoulder; 2) a Japanese hunter in his 50s in a grey hunting vest and orange cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, standing and looking off in the direction the first man points; 3) a Japanese hunter in his 40s in a dark green jacket and knitted cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, one hand shading his eyes. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. NOT smiling, NOT grinning. All have eyebrows driven down hard and pulled together, eyes narrowed to a hard unblinking stare, mouths pressed into flat grim lines. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
→ 背景再使用: 113
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. The skull is from an adult Japanese black bear (Asiatic black bear, Ursus thibetanus japonicus), an animal of 140cm body length and 84kg in life with a glossy jet-black coat, large round ears, a short blunt muzzle and NO shoulder hump, so the skull is clearly much smaller and lighter-boned than a grizzly or brown bear skull, and it is resting quietly and undisturbed. a single clean bleached Asiatic black bear skull drawn alone in the centre of the frame, turned in a strict true side profile with the near eye socket visible and the far eye socket completely hidden, the whole length of the skull oriented horizontally across the frame from left to right, the camera level with the skull rather than looking down at it, resting on a plain dark wooden base. Along the very top of the cranium, a tall narrow sagittal crest projects upward as a clearly visible ridge extending from front to back. The crest rises above the skull's top silhouette with clean open space above it; its entire raised profile must be unmistakable, not a painted line and not hidden on the far side. Long canine teeth and the full tooth row visible. The bone is dry and complete with no tissue of any kind. Nothing else in the frame, nothing of the surroundings. The whole skull is in frame. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. No lettering, no readable characters anywhere. Generate 1 image.
```
背景プロンプト（16:9）:
```
A low empty shelf against a plain wall in the reception room of a private house in Tozawa, Yamagata, Japan in late autumn. A framed blank picture and a folded newspaper lie far to the side, leaving the centre of the shelf completely empty. Soft warm light from one side, dim but NOT pure black — the wall and shelf stay clearly readable. No skulls, no bones, no specimens, no animals, no display objects at the centre. No people, no figures, no humans visible. No lettering, no readable characters anywhere. No snow anywhere, no frost, no winter. Photorealistic, shot on RED camera. Documentary style. 16:9 aspect ratio. Generate 1 image.
```
...
静止画プロンプト（16:9・フォトリアル）:
```
The skull is from an adult Japanese black bear (Asiatic black bear, Ursus thibetanus japonicus), an animal of 140cm body length and 84kg in life with a glossy jet-black coat, large round ears, a short blunt muzzle and NO shoulder hump, so the skull is clearly much smaller and lighter-boned than a grizzly or brown bear skull, and it is resting quietly and undisturbed. a clean bleached Asiatic black bear skull resting on a plain dark wooden base on a table in a private house in Yamagata, Japan in late autumn, seen from above in a top-down view matching the angle of the reference image, the camera directly over the skull and looking down onto the top of the cranium, with both sides of the skull equally visible and the neck end toward the bottom of the frame. Where a narrow bony crest would normally stand up along the centre line, the bone is instead flattened into a smooth shallow curve with no raised ridge at all, and the surrounding bone carries several shallow darkened depressions. The bone is dry and complete with no tissue of any kind, a warm ivory white. Soft warm indoor light from one side, shallow depth of field with the flattened centre line sharp. Dim at the edges but NOT pure black — the flattened crest area stays clearly readable. No snow anywhere, no frost, no winter. Nothing red and nothing stained. No blood, no wounds, no gore. No lettering, no readable characters anywhere. Photorealistic, shot on RED camera, 100mm macro lens. Documentary evidence photography style. 16:9 aspect ratio. No people, no humans visible. Generate 1 image.
```
Google Flow動画プロンプト:
```
The skull is from an adult Japanese black bear (Asiatic black bear, Ursus thibetanus japonicus), an animal of 140cm body length and 84kg in life with a glossy jet-black coat, large round ears, a short blunt muzzle and NO shoulder hump, so the skull is clearly much smaller and lighter-boned than a grizzly or brown bear skull, and it is resting quietly and undisturbed. a very slow close push in on a clean bleached bear skull on a dark wooden base in a private house in Yamagata, Japan in late autumn, seen from above in the same top-down view, the camera directly over the skull looking down onto the top of the cranium, with both sides equally visible and the neck end toward the bottom of the frame. Where a bony crest would normally stand along the centre line of the cranium, the bone is flattened into a smooth shallow curve with no ridge at all and several shallow darkened depressions around it. Warm indoor light rakes across the dry bone as the camera closes in. Nothing else moves. Late autumn, no snow anywhere, no frost, no winter. Dim at the edges but not pure black. No blood, no gore. No lettering anywhere. No people visible. 5 seconds. Photorealistic, shot on RED camera. Documentary evidence style.
```
...
キャラプロンプト（1:1）:
```
(CHAR-08 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) CHAR-08: Japanese man in his late 60s, solidly built, thick white hair swept back, deeply lined weathered face, sunken cheeks and age spots, CLEAN-SHAVEN with no beard, no moustache and no stubble, NOT middle-aged, wearing an olive-brown hunting vest over a checked wool shirt, dark brown trousers and leather boots. He is kneeling with one hand resting on the base of a clean bleached bear skull drawn in the same cartoon style in front of him, listening to the other man with raised eyebrows, eyes stretched wide and mouth open in surprise, his torso leaning back slightly. The skull is from an animal of 140cm body length and 84kg in life with a glossy jet-black coat, large round ears, a short blunt muzzle and NO shoulder hump, and it is resting quietly and undisturbed. 2) A Japanese man in his 40s in a grey sweatshirt and dark trousers, CLEAN-SHAVEN with no beard, no moustache and no stubble, kneeling opposite and speaking calmly to CHAR-08, one hand held open at waist height, eyebrows relaxed, eyes at their normal width and lips slightly parted mid-sentence, NOT surprised and NOT shouting. Only the skull as a prop, nothing else around them. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-13 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-13: a Japanese black bear cub, about 60cm body length and about 12kg, roughly one year old, soft glossy jet-black fur, an oversized round head, a white crescent-moon patch across the chest, large round ears, a short blunt muzzle, NO shoulder hump, short stubby legs, sitting up on its haunches ON ALL FOURS with its front paws on the ground, looking up with trusting affectionate eyes, a simple rope collar around its neck with a long tether rope attached to the collar, trailing along the ground to the right and ending in a clearly visible tying loop, all drawn in the same cartoon style. It is clearly a cub, far smaller than an adult bear, and it is calm and not aggressive. NOT reared up, NOT on two legs. Only the rope collar and its attached tether rope as props, nothing else around it. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
An interior corner of the enclosed earthen-floor doma of an old farmhouse in a Japanese mountain village in Yamagata, Japan in early summer: packed earth floor, rough plaster walls meeting at the back, exposed wooden beams and a thick wooden support post on the right, stacked firewood and an enamel bowl near the wall. The left centre of the earthen floor is empty and clearly visible. Viewed from inside the house, entirely indoors, NOT an outdoor yard and NOT an open-sided shed. Soft early-summer daylight enters through a small window, no snow, no frost, no ice. Framed from about one metre above the floor and three metres back, with the base of the right-hand post clearly visible. Photorealistic, shot on RED camera. Documentary style. 16:9 aspect ratio. No animals, no bears, no people, no figures, no humans visible. Empty interior only. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
[Generic group](CHAR-13 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Seen from the side. Left: a Japanese farmer in his 50s in a faded blue work jacket, grey work trousers and rubber boots, CLEAN-SHAVEN with no beard, no moustache and no stubble, both hands gripping a long plain wooden stick that he has just swung down hard, the stick caught at the exact instant it lands on the top of the bear cub's head, his face screwed up with the eyes squeezed shut into tight creases, teeth bared, tendons standing out on his neck. Right, at his feet: CHAR-13: a Japanese black bear cub, about 60cm body length and about 12kg, soft glossy jet-black fur, an oversized round head, a white crescent-moon patch across the chest, large round ears, short blunt muzzle, NO shoulder hump, ON ALL FOURS, hunched down low with its head pulled in, eyes squeezed shut, ears flattened right back, a few short motion lines around the point of impact, nothing red and nothing stained. Only the wooden stick as a prop, nothing else around them. Both have large heads, short compact torsos and short stubby limbs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no gore. Generate 1 image.
```
→ 背景再使用: 012
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. Left to right: 1) a Japanese man in his 40s in a grey sweatshirt and dark trousers, CLEAN-SHAVEN with no beard, no moustache and no stubble, seated and talking with both hands raised and open in front of him, mouth slightly open mid-sentence, eyebrows relaxed and eyes open at their normal width; 2) a Japanese wildlife researcher, man in his 50s in a khaki field vest over a checked shirt and round glasses, CLEAN-SHAVEN with no beard, no moustache and no stubble, seated opposite with an open notebook on his knee and a pen moving, head nodding slightly, earnest and level expression, eyebrows relaxed with no furrow between them, eyes open at their normal width and mouth closed in a soft even line. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and they are not the same height. The notebook carries no lettering and no readable characters. Both have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. Generate 1 image.
```
→ 背景再使用: 247
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A single clean bleached Asiatic black bear skull drawn alone in the centre of the frame, turned so the rear half of the cranium faces the viewer and the neck end is nearest the camera, resting on a plain dark wooden base. The skull is from an animal of 140cm body length and 84kg in life with a glossy jet-black coat, large round ears, a short blunt muzzle and NO shoulder hump, and it is resting quietly and undisturbed. Along the centre line toward the neck end, the sagittal crest is visibly CRUSHED DOWN and flattened below the surrounding dome into a broad shallow dent, with an irregular depressed edge instead of a raised ridge. Around this flattened area are FOUR separate clearly visible dark charcoal-grey pits, each with a distinct recessed centre and shaded rim; they are separated from each other and large enough to count. The flattened crest and dark pits are the focal details. No intact raised crest on this skull. Nothing else in the frame, nothing of the surroundings. The whole skull is in frame. Full body. White background. 1:1 aspect ratio. No blood, no wounds, no gore. No lettering, no readable characters anywhere. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
(CHAR-09 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-09: Japanese local government official, man in his late 40s, average build, short neatly parted black hair with slight greying at the temples, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a dark grey blazer over a pale blue shirt, no tie, dark trousers and a plain lanyard with a blank card and no lettering, no crest, no emblem and no logo on anything he wears, standing and holding a bundle of loose papers in one hand while the index finger of the other hand rises as something comes back to him, lips only slightly parted while speaking softly, eyebrows resting level with no furrow between them, eyes open at their normal width and jaw relaxed. He is calmly recalling a memory, NOT angry, NOT surprised, NOT shouting and NOT frightened. Only the papers as a prop, nothing else around him. The papers carry no lettering and no readable characters. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-09 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-09: Japanese local government official, man in his late 40s, average build, short neatly parted black hair with slight greying at the temples, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a dark grey blazer over a pale blue shirt, no tie, dark trousers and a plain lanyard with a blank card and no lettering, no crest, no emblem and no logo on anything he wears, standing on the left side of the frame in right-facing three-quarter profile, one arm extended horizontally toward the right with the index finger pointing at shoulder height, the other hand held flat at waist height, lips slightly parted while explaining calmly, earnest and level expression, eyebrows relaxed with no furrow between them. NOT grinning, NOT angry, NOT frightened, NOT grim. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. Generate 1 image.
```
背景プロンプト（16:9）:
```
...
キャラプロンプト（1:1）:
```
(CHAR-09 再利用) Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. CHAR-09: Japanese local government official, man in his late 40s, average build, short neatly parted black hair with slight greying at the temples, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a dark grey blazer over a pale blue shirt, no tie, dark trousers and a plain lanyard with a blank card and no lettering, no crest, no emblem and no logo on anything he wears, standing squarely facing the viewer with BOTH SHOULDERS EQUALLY VISIBLE and the shoulder lines parallel to the picture plane, both hands moving in a small measured gesture at chest height, lips only slightly parted as he speaks steadily, jaw loose with no tension, earnest and calm expression, eyebrows relaxed and level with no furrow between them, eyes open at their normal width. NOT surprised, NOT wide-eyed, NOT shouting. NOT grinning, NOT angry, NOT frightened, NOT grim. He has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw him with realistic adult proportions. Full body. White background. 1:1 aspect ratio. Generate 1 image.
```
→ 背景再使用: 268
...
背景プロンプト（16:9）:
```
A gentle wooded foothill above Tozawa village beside the Mogami River in Yamagata, Japan in mid-March. In the foreground a broad low-angle slope with bare deciduous trunks and patches of deep melting snow, dark wet ground showing through; the centre foreground is left clear. Below lies a small riverside settlement with individual low house rooftops beside a winding broad river. The horizon consists of LOW rounded rolling hills with smooth forested ridgelines, modest foothills only. No towering alpine peaks, no jagged mountains, no sheer rock faces, no cliffs and no high snowy mountain range. Camera about 1.5 metres above the gentle slope looking across and slightly down toward the settlement and river; terrain is softly undulating, not steep. Mid-March, cold flat overcast daylight, patchy snow in the village and on the rounded hills. Photorealistic, shot on RED camera. Documentary style. 16:9 aspect ratio. No animals, no bears, no people, no figures, no humans visible. Empty landscape only. No blood, no wounds, no gore. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
(CHAR-09 再利用)[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. THREE people in an inward-facing semicircle, arranged at three different depths, leaving a wide empty central space. They are having a calm face-to-face meeting, NOT lined up shoulder to shoulder and NOT facing the viewer in a row. 1) At the left foreground, CHAR-09: Japanese local government official, man in his late 40s, average build, short neatly parted black hair with slight greying at the temples, CLEAN-SHAVEN with no beard, no moustache and no stubble, wearing a dark grey blazer over a pale blue shirt, no tie, dark trousers and a plain lanyard with a blank card and no lettering, no crest, no emblem and no logo on anything he wears, shown in right-facing profile, leaning slightly forward with his index finger pointing diagonally down and inward at waist height. 2) At the far centre, a Japanese hunter in his 60s with short grey hair under an orange cap, CLEAN-SHAVEN with no beard, no moustache and no stubble, in an olive-brown hunting vest, khaki trousers and rubber boots, shown in three-quarter front view with arms folded, nodding toward CHAR-09. 3) At the right foreground, a Japanese woman in her 30s with a chin-length straight black bob, CLEAN-SHAVEN with no beard, no moustache and no stubble, in a plain grey work coat, dark trousers and flat shoes, shown in left-facing profile holding a clipboard and writing while looking toward the other two. All three have relaxed eyebrows, eyes at their normal width and gently closed or slightly speaking mouths, NOT angry or startled. Only the clipboard and pen as props, nothing else around them. The clipboard has no lettering or readable characters. Every person is a distinct individual and no two dressed alike. NO TWO OF THEM SHARE A FACE, A HAIRSTYLE OR AN OUTFIT, and no two of them are the same height. All have large heads, short compact torsos and short stubby arms and legs, roughly four to five heads tall. Do NOT draw them with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. No blood, no wounds, no gore. Generate 1 image.
```
背景プロンプト（16:9）:
```
The interior of the same small Japanese rural village office in mid-March: steel desks, shelves of unmarked binders, a kerosene heater with a kettle and a window showing deep winter snow banked outside and low snow-covered hills beyond. A waist-high rectangular meeting table fills the middle of the frame, with a LARGE PAPER MAP spread flat across its top showing the winding Mogami River, village roads and low hill contours in muted colours, no labels. The map is entirely visible from a slightly elevated three-quarter view about 1.8 metres high and four metres back. Clear empty floor space is visible at the left near corner, the far side and the right near corner of the table. No real institution name, no crest, no emblem, no logo, no lettering, no readable characters anywhere. Mid-March, soft flat interior daylight, deep snow visible outside. Photorealistic, shot on RED camera. Documentary style. 16:9 aspect ratio. No people, no figures, no humans visible. Empty interior only. Generate 1 image.
```
...
キャラプロンプト（1:1）:
```
[Generic group] Cute cartoon character design, thick black outlines, flat cel-shaded colors, large expressive eyes, slightly chibi proportions, children's animation style. A Japanese prefectural official, woman in her 40s in a dark blazer over a pale shirt, CLEAN-SHAVEN with no beard, no moustache and no stubble, no crest, no emblem and no logo on anything she wears, standing in the left half of the frame in right-facing three-quarter profile with one arm extended to the right and placing a small round marker at head height, the other hand holding two more markers, mouth gently closed in a soft even line, jaw relaxed, eyebrows level with no furrow between them, eyes open at their normal width. Calm and attentive expression, NOT angry, NOT grim, NOT startled and NOT frightened. Only the markers as props, nothing else around her. She has a large head, a short compact torso and short stubby arms and legs, roughly four to five heads tall. Do NOT draw her with realistic adult proportions. Full body. White background. 1:1 aspect ratio. No lettering, no readable characters anywhere. Generate 1 image.
```
背景プロンプト（16:9）:
```
