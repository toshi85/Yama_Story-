...
| 2026-09-18 | せたな町 | §2・§5・§7〜§9 | 「採りに出かけた山菜は、カタクリ。」／「現場は、高さ約30メートルの丘にある山林。」／「集落に暮らすのは、38世帯92人。」／「町からの参加は、奥尻町を除く6町。」 | （削除） | YCP-061 | `Correction_Patterns.md`／`SCRIPT_CHECKLIST.md` |
| 2026-09-18 | せたな町 | §6 | 「道総研は、現場に残っていたクマの毛を採取。」＋「その毛を使い、遺伝子を調べます。」 | 「道総研は、現場に残っていたクマの毛を採取し、遺伝子を調べます。」 | YCP-062 | `Correction_Patterns.md`／`validate_yama_narrative.py` WARN |
| 2026-09-18 | せたな町 | §4・§9・§11 | 「北海道の出先機関、檜山振興局は、周辺の町へ緊急の文書を送ります。」／「クマを目撃したときも、こまめに通報してもらうよう要請しました。」／「狩猟免許の取得だけでなく、猟銃を持つ許可や、猟銃などの購入費も助成しています。」 | 「事態の深刻さを理解した北海道の行政は、周辺の町へ緊急の注意文書を送ることに。」／「少しでも多く情報がほしい状況だったので、クマを目撃したときも、こまめに通報してもらうよう要請しました。」／「その問題に対処するため、狩猟免許の取得や猟銃を持つ許可、猟銃などの購入費も町が援助するよう変更。」 | YCP-063 | `Correction_Patterns.md`／`SCRIPT_CHECKLIST.md` |
| 2026-09-18 | せたな町 | §8 | 「4月23日」 | 「4月23日（事件から7日後）」 | YCP-064 | `Correction_Patterns.md`／`SCRIPT_CHECKLIST.md` |
| 2026-09-18 | せたな町 | §8〜§9 | §8「4月23日」＋§9「4月23日の対策会議」 | （同じ会議を§8の1つの流れにまとめ、§9で再掲しない） | YCP-065 | `Correction_Patterns.md`／`validate_yama_narrative.py` WARN |
| 2026-09-18 | せたな町 | §4 | 「北海道の出先機関、檜山振興局は、周辺の町へ緊急の文書を送ります。」 | 「事態の深刻さを理解した北海道の行政は、周辺の町へ緊急の注意文書を送ることに。」 | YCP-066 | `Correction_Patterns.md`／`SCRIPT_CHECKLIST.md` |
| 2026-09-18 | せたな町 | §4 | 「遺体は両手両足の筋肉を食い取られており、見るに堪えない状況でした。」 | 「両手両足の筋肉を食い取られており、見るに堪えない状況だったと言います。」 | YCP-067 | `Correction_Patterns.md`／`SCRIPT_CHECKLIST.md` |
