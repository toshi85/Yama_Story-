...
【制作メモ】ASSET-039 [Lovart動画] 台本L284-L290
...
→ **Google Flow動画プロンプト:**
```
Close-up of a laboratory bench in Hokkaido, Japan. A DNA analysis report document slowly comes into focus. Camera slowly pushes in on the printed results page. Clinical sterile lighting. 5 seconds.
```
→ 編集者指示: 画面下部に「DNA鑑定結果：駆除された母グマ＝襲撃個体 — 一致」のテキスト追加
...
【制作メモ】ASSET-051 [Lovart動画] 台本L400-L404
...
→ **Google Flow動画プロンプト:**
```
Multiple Japanese tourists crowding near a roadside in Shiretoko, holding smartphones and cameras. They lean forward excitedly, snapping photos toward the forest edge. Bright summer day, desaturated flashback tones. Camera slowly zooms in on the crowd. 5 seconds.
```
→ 編集者指示: 回想シーン。彩度低め＋ビネット。テロップ追加：「"観光客に人気のあるヒグマだった" — 毎日新聞」
...
【制作メモ】ASSET-064 [Lovart動画] 台本L516
